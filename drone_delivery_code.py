"""
Drone delivery: 
Hello Guys we are going to build a mission in mission planner in almost all Ardupilot , uploading the mission to the drone.
Actually this does connect with the vehicle and check if a new mission has been uploaded. 
When Ever a valid mission is available using Ardu, we takeoff in GUIDED mode and then we switch
to AUTO.
When the mission is completed we command to Go back to home and land where it is take off
"""
...
#--------------------------------------------------
#----I Started with defining Function if you want to make change in operation time you can change the value and also conditions  
#--------------------------------------------------
#-- Here I defined arm and takeoff
...
def clear_mission(vehicle):
    ...
    # Do be confused What I did is After clearing the mission you MUST re-download the mission from the vehicle
...
def download_mission(vehicle):
    """
   Then checking the present avliable missions and  Download the current mission from the vehicle.
    """
    cmds = vehicle.commands
    cmds.download()
